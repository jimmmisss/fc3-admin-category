...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAValidCategory_whenCallsUpdate_shouldReturnCategoryUpdated() {
        ...
        final var aCategory = Category.newCategory("Film", expectedDescription, expectedIsActive);
        ...
        final var actualUpdatedCategory = categoryGateway.update(actualCategory);

        Assertions.assertEquals(1, categoryRepository.count());

        Assertions.assertEquals(aCategory.getId(), actualUpdatedCategory.getId());
        Assertions.assertEquals(expectedName, actualUpdatedCategory.getName());
        Assertions.assertEquals(expectedDescription, actualUpdatedCategory.getDescription());
        Assertions.assertEquals(expectedIsActive, actualUpdatedCategory.isActive());
        Assertions.assertEquals(aCategory.getCreatedAt(), actualUpdatedCategory.getCreatedAt());
        Assertions.assertNotEquals(aCategory.getUpdatedAt(), actualUpdatedCategory.getUpdatedAt());
        Assertions.assertEquals(aCategory.getDeletedAt(), actualUpdatedCategory.getDeletedAt());
        Assertions.assertNull(actualUpdatedCategory.getDeletedAt());
        ...
        Assertions.assertEquals(expectedIsActive, actualEntity.isActive());
        Assertions.assertEquals(aCategory.getCreatedAt(), actualEntity.getCreatedAt());
        Assertions.assertNotEquals(aCategory.getUpdatedAt(), actualEntity.getUpdatedAt());
        Assertions.assertEquals(aCategory.getDeletedAt(), actualEntity.getDeletedAt());
        Assertions.assertNull(actualEntity.getDeletedAt());
    }
    ...
    public void givenPrePersistedCategories_whenCallsFindAll_shouldReturnPaginated() {
        ...
        final var aCategory = Category.newCategory("Filmes", null, true);
        final var anotherCategory = Category.newCategory("Séries", null, true);
        ...
        categoryRepository.saveAll(List.of(
                ...
                CategoryJpaEntity.from(anotherCategory),
        ...
        Assertions.assertEquals(expectedTotalElements, actualResult.total());
        Assertions.assertEquals(expectedPerPage, actualResult.items().size());
        Assertions.assertEquals(aCategory.getId(), actualResult.items().get(0).getId());
    }
    ...
    public void givenEmptyCategoriesTable_whenCallsFindAll_shouldReturnEmptyPage() {
        ...
        Assertions.assertEquals(expectedPerPage, actualResult.perPage());
        Assertions.assertEquals(expectedTotalElements, actualResult.total());
        Assertions.assertEquals(expectedTotalElements, actualResult.items().size());
    }
    ...
    public void givenFollowPagination_whenCallsFindAllWithPage1_shouldReturnPaginated() {
        ...
        var query = new SearchQuery(1, 1, "", "name", "asc");
    ...
    public void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchsCategoryDescription_shouldReturnPaginated() {
        ...
        final var filmes = Category.newCategory("Filmes", null, true);
        final var series = Category.newCategory("Séries", null, true);
        final var documentarios = Category.newCategory("Documentários", "A categoria mais assistida", true);
    ...
    public void givenPrePersistedCategories_whenCallsExistsByIds_shouldReturnIds() {
        ...
        final var ids = List.of(filmes.getId(), series.getId(), documentarios.getId(), CategoryID.from("123"));
